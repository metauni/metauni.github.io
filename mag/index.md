...
* **Where**: [metauni](https://metauni.org). See the [instructions](https://metauni.org/posts/instructions/instructions). We teach in the Metaverse because it is the initial object in the category of learning environments.
