...
* **5/2/2021**: [Lucas Cantor](https://www.lucascantormusic.com/) on music {`#2A`, `#2B`}. We had a pre-event session on the Chinese Remainder Theorem by Will Troiani ([video](https://youtu.be/SuBBHUjOywM)).
