...
**Quick start**: install [Roblox](https://www.roblox.com/) and [Discord](https://www.discord.com) programs, join the Rising Sea [Discord](https://discord.gg/9yBaAxPSK8) and [Roblox world](https://www.roblox.com/games/6224932973/The-Rising-Sea) and in Discord type `!register fred` where `fred` is replaced by your Roblox username in the `#registration` channel to activate location-specific voice chat. See Instructions below for more details.
