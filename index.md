...
**Quick start (Rising Sea node)**: install [Roblox](https://www.roblox.com/) and [Discord](https://www.discord.com) programs, join the [TRS Discord](https://discord.gg/9yBaAxPSK8), send a message `!register <roblox-username>` in the `#registration` channel and enter the [metauni Hub](https://www.roblox.com/games/6233302798/metauni-Hub). See the [instructions](https://metauni.org/posts/instructions/instructions) for more details.
...
2. **No Video.** In Zoom the feeling of co-presence is based fundamentally on being able to see other people's faces. This is better than lecturing to a black screen, but it is exhausting to watch faces on a video call for hours. In a 3D environment you still get a sense of other people paying attention to what is going on, without having to constantly see their faces and your own.
