...
**Quick start (Rising Sea node)**: install [Roblox](https://www.roblox.com/) and [Discord](https://www.discord.com) programs, join the Rising Sea [Discord](https://discord.gg/9yBaAxPSK8) and [Roblox world](https://www.roblox.com/games/6224932973/The-Rising-Sea) and in Discord send a message `!register Severian` in the `#registration` channel where `Severian` is your Roblox username. See Instructions below for more details.
