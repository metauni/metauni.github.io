...
* **12/8/2021**: **Festival of Mathematics** from **10am-3pm** Melbourne time (so from 5pm Los Angeles) in [LC002](https://www.roblox.com/games/7168699181/metauni-LC002-Research-Agora) (the Research Agora) on the [TRS Discord](https://discord.gg/9yBaAxPSK8) in voice channel `LC002`. If you haven't joined a metauni event before, see the [instructions](https://metauni.org/posts/instructions/instructions). There is a [festival page](https://metauni.org/posts/instructions/instructions) which contains any references or links given by the speakers. The schedule:
